...
title: "Notification, Stop, and Compact Hooks -- Arcanum Wiki"
tags: [hooks, stop-session, precompact-postcompact, sessionstart, filechanged]
---
...
- [Hooks Overview](330.010_overview.md) -- Full system architecture
- [Hook Types](hook_types.md) -- Command, prompt, agent, http
- [Compaction Instructions](../110_core/compaction_instructions.md) -- PreCompact hook integration
