    ...
    },
    {
        ...
        "shortcuts": [
            ...
            {"name": "1. YMIR Sniffer", "icon": "ability_hunter_snipershot.png",
             "desc": "Retail packet sniffer for 12.0.1 build 66709. Launch BEFORE opening the game client. Captures live traffic into .pkt files.",
             "cmd": [os.path.join(EXTTOOLS, "ymir_retail_12.0.1.66709", "ymir_retail.exe")],
             "cwd": os.path.join(EXTTOOLS, "ymir_retail_12.0.1.66709")},
    ...
    },
    {
        ...
        "shortcuts": [
            {"name": "wow.tools.local", "icon": "inv_misc_spyglass_01.png",
             "desc": "Local DB2 data browser at http://localhost:5000 (build 66709). Browse all 1,097 DB2 tables. Waits for startup then opens browser.",
