...
def create_all():
    ...
    make_shortcut(d, "1. YMIR Sniffer",
        os.path.join(EXTTOOLS, r"ymir_retail_12.0.1.66709\ymir_retail.exe"), None,
        os.path.join(EXTTOOLS, "ymir_retail_12.0.1.66709"),
        "STEP 1 — Retail packet sniffer for 12.0.1 build 66709. Captures live WoW traffic into .pkt files. Launch this BEFORE opening the game client. Output: .pkt files for WPP to parse.",
    ...
    make_shortcut(d, "wow.tools.local",
        ...
        "Start wow.tools.local — local DB2 data browser at http://localhost:5000 (build 66709). Browse item appearances, spells, creatures, maps, and all 1,097 DB2 tables. Waits for startup then opens browser.",
