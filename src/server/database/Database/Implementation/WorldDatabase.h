...
enum WorldDatabaseStatements : uint32
{
    ...
    */
    ...
    WORLD_REP_DRESSNPC_OUTFIT,
    WORLD_DEL_CREATURE_TEMPLATE,
    WORLD_DEL_CREATURE_EQUIP_TEMPLATE,
    ...
    WORLD_SEL_NEAREST_CREATURE_BY_EID,
    WORLD_SEL_NEAREST_CREATURE,
    WORLD_SEL_NEAREST_CREATURES,
