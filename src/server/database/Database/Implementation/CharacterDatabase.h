...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_COMPANION_SQUAD,
    CHAR_DEL_COMPANION_SQUAD,
    CHAR_INS_COMPANION_SQUAD,
    CHAR_SEL_COMPANION_CONTROL,
    CHAR_DEL_COMPANION_CONTROL,
    CHAR_REP_COMPANION_CONTROL,
