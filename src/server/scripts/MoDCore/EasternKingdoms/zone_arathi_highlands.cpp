            ...
            void WaypointReached(uint32 waypointId, uint32 /*pathId*/) override
            {
                ...
                switch (waypointId)
                {
                    ...
                    case 8:
                        ...
                        me->SummonCreature(NPC_VENGEFUL_SURGE, -2065.505f, -2136.88f, 22.20362f, 1.0f, TEMPSUMMON_CORPSE_DESPAWN, 0s);
                        me->SummonCreature(NPC_VENGEFUL_SURGE, -2059.249f, -2134.88f, 21.51582f, 1.0f, TEMPSUMMON_CORPSE_DESPAWN, 0s);
                        break;
                    case 11:
                        Talk(SAY_PROGRESS_5, player);
                        events.ScheduleEvent(EVENT_SAY_6, 11s);
                        break;
                    case 17:
                        Talk(SAY_PROGRESS_7, player);
                        events.ScheduleEvent(EVENT_SAY_8, 6s);
                        break;
                }
            }
