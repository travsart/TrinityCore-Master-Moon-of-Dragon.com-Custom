...
// npc_forsaken_dreadmage_186199
class npc_forsaken_dreadmage_186199 : public CreatureScript
{
public:
    npc_forsaken_dreadmage_186199() : CreatureScript("npc_forsaken_dreadmage_186199") {}

    struct npc_forsaken_dreadmage_186199AI : public ScriptedAI
    {
        npc_forsaken_dreadmage_186199AI(Creature* creature) : ScriptedAI(creature) {}

        bool OnGossipHello(Player* player) override
        {
            if (player->GetQuestStatus(65656) != QUEST_STATUS_NONE)
            {
                AddGossipItemFor(player, GossipOptionNpc::None, "Send me to Tirisfal Glades.", GOSSIP_SENDER_MAIN, 0);
        ...
        bool OnGossipSelect(Player* player, uint32 /*menuId*/, uint32 gossipListId) override
        {
            ...
            case 0:
                CloseGossipMenuFor(player);
                player->KilledMonsterCredit(186199);
                //player->GetPhaseShift().AddPhase(11519, PhaseFlags::None, nullptr);
                player->TeleportTo(2532, 2242.2500000f, 600.822021f, 33.339699f, 4.725340f); // Teleport to Tirisfal Glades
                break;
            }
    ...
    {
        return new npc_forsaken_dreadmage_186199AI(creature);
    }
};
...
public:
    ...
    struct npc_polemarch_adrestes_171787AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            if (player->GetQuestStatus(62000) != QUEST_STATUS_NONE || player->GetQuestStatus(57878) != QUEST_STATUS_NONE) {
        ...
        bool OnGossipSelect(Player* player, uint32 /*menuId*/, uint32 gossipListId) override
        {
            ...
            case 0:
                ...
                player->GetSession()->SendCovenantPreview(player->GetGUID(), 0);  // kyrian
                CloseGossipMenuFor(player);
                break;
            }
            return true;
...
public:
    ...
    struct npc_general_draven_171589AI : public ScriptedAI
    {
        ...
        bool OnGossipHello(Player* player) override
        {
            if (player->GetQuestStatus(62000) != QUEST_STATUS_NONE || player->GetQuestStatus(57878) != QUEST_STATUS_NONE) // This menu show only if u have Choosing Your Purpose quest.
            {
            ...
            me->AddDelayedEvent(8000, [this]()
                {
                    ...
                    for (std::list<Creature*>::const_iterator itr = cList.begin(); itr != cList.end(); ++itr)
                    {
                        ...
                        {
                            adrestes->DespawnOrUnsummon(6000ms);
...
{
public:
    IntoTheMaw() : PlayerScript("IntoTheMaw"), IntoMaw(0) {} // Initialize IntoMaw to 0  
...
{
    new npc_forsaken_dreadmage_186199();
