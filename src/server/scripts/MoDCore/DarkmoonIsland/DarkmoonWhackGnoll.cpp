...
#define GNOLL_TIMER         3s
#define DOLL_TIMER          6s
#define BOSS_TIMER          10s
        ...
        struct npc_whack_gnoll_molaAI : public ScriptedAI
        {
            ...
            bool OnGossipHello(Player* player) override
            {
                ...
                if (player->GetQuestStatus(QUEST_WHACK_A_GNOLL) == QUEST_STATUS_INCOMPLETE)
                    AddGossipItemFor(player, GossipOptionNpc::None, "Je souhaite jouer a Cogne-Gnoll !", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            ...
            bool OnGossipSelect(Player* player, uint32 /*menuId*/, uint32 /*gossipListId*/) override
            {
                ...
                {
                    me->Whisper("Vous devez posseder un Jeton de Sombrelune pour jouer a Cogne-Gnoll !", LANG_UNIVERSAL, player);
                    return true;
                }
