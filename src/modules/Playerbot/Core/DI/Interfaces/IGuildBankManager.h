...
public:
     ...
     */
    virtual bool DepositItem(uint32 itemGuid, uint32 tabId, uint32 stackCount) = 0;
     ...
     * @return true if successful
     */
    virtual bool WithdrawItem(uint32 tabId, uint32 slotId, uint32 stackCount) = 0;
     ...
     * @return true if successful
     */
    virtual bool MoveItem(uint32 fromTab, uint32 fromSlot, uint32 toTab, uint32 toSlot) = 0;
