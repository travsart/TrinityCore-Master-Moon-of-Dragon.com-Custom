 ...
 *
 * Augmentation Evoker Specialization - Comprehensive Unit Tests
 *
 * Role: Support DPS
 * Resource: Essence
 *
 * Tests all aspects of Augmentation Evoker AI behavior including:
 ...
 * - Support DPS-specific mechanics
 * - Edge cases
...
class AugmentationEvokerTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_EVOKER, 80, 3);
...
TEST_F(AugmentationEvokerTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(AugmentationEvokerTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(AugmentationEvokerTest, ResourceManagement_UsesEssence_Efficiently)
{
...
TEST_F(AugmentationEvokerTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(AugmentationEvokerTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
// ============================================================================
// TEST 6: DEFENSIVE COOLDOWNS - Support DPS SPECIFIC
// ============================================================================

TEST_F(AugmentationEvokerTest, DefensiveCooldowns_UsesDefensives_SUPPORT DPS)
{
...
TEST_F(AugmentationEvokerTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(AugmentationEvokerTest, TargetSelection_PrioritizesSupport DPSTargets)
{
...
TEST_F(AugmentationEvokerTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(AugmentationEvokerTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(AugmentationEvokerTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(AugmentationEvokerTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(AugmentationEvokerTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(AugmentationEvokerTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(AugmentationEvokerTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Augmentation Evoker:\n";
    metrics.Print();
}
