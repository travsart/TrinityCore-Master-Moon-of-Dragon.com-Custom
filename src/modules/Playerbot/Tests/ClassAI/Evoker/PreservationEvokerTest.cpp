 ...
 *
 * Preservation Evoker Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Essence
 *
 * Tests all aspects of Preservation Evoker AI behavior including:
...
class PreservationEvokerTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_EVOKER, 80, 2);
...
TEST_F(PreservationEvokerTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(PreservationEvokerTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(PreservationEvokerTest, ResourceManagement_UsesEssence_Efficiently)
{
...
TEST_F(PreservationEvokerTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(PreservationEvokerTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(PreservationEvokerTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(PreservationEvokerTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(PreservationEvokerTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(PreservationEvokerTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(PreservationEvokerTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(PreservationEvokerTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(PreservationEvokerTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(PreservationEvokerTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(PreservationEvokerTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(PreservationEvokerTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Preservation Evoker:\n";
    metrics.Print();
}
