 ...
 *
 * Devastation Evoker Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Essence
 *
 * Tests all aspects of Devastation Evoker AI behavior including:
...
class DevastationEvokerTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_EVOKER, 80, 1);
...
TEST_F(DevastationEvokerTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(DevastationEvokerTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(DevastationEvokerTest, ResourceManagement_UsesEssence_Efficiently)
{
...
TEST_F(DevastationEvokerTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(DevastationEvokerTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(DevastationEvokerTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(DevastationEvokerTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(DevastationEvokerTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(DevastationEvokerTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(DevastationEvokerTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(DevastationEvokerTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(DevastationEvokerTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(DevastationEvokerTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(DevastationEvokerTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(DevastationEvokerTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Devastation Evoker:\n";
    metrics.Print();
}
