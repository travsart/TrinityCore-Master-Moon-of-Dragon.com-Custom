 ...
 *
 * Unholy DeathKnight Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Runes + Runic Power + Pet
 *
 * Tests all aspects of Unholy DeathKnight AI behavior including:
...
class UnholyDeathKnightTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DEATH_KNIGHT, 80, 3);
        bot->SetMaxHealth(35000);
        bot->SetHealth(35000);
        AddSpells();
...
TEST_F(UnholyDeathKnightTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(UnholyDeathKnightTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(UnholyDeathKnightTest, ResourceManagement_UsesRunes + Runic Power + Pet_Efficiently)
{
...
TEST_F(UnholyDeathKnightTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(UnholyDeathKnightTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
// ============================================================================
// TEST 6: DEFENSIVE COOLDOWNS - Melee DPS SPECIFIC
// ============================================================================

TEST_F(UnholyDeathKnightTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(UnholyDeathKnightTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(UnholyDeathKnightTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(UnholyDeathKnightTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(UnholyDeathKnightTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(UnholyDeathKnightTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(UnholyDeathKnightTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(UnholyDeathKnightTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(UnholyDeathKnightTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(UnholyDeathKnightTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Unholy DeathKnight:\n";
    metrics.Print();
}
