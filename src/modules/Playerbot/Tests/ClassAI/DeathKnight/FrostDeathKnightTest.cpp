 ...
 *
 * Frost DeathKnight Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Runes + Runic Power
 *
 * Tests all aspects of Frost DeathKnight AI behavior including:
...
class FrostDeathKnightTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DEATH_KNIGHT, 80, 2);
...
TEST_F(FrostDeathKnightTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(FrostDeathKnightTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(FrostDeathKnightTest, ResourceManagement_UsesRunes + Runic Power_Efficiently)
{
...
TEST_F(FrostDeathKnightTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(FrostDeathKnightTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(FrostDeathKnightTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(FrostDeathKnightTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(FrostDeathKnightTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(FrostDeathKnightTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(FrostDeathKnightTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(FrostDeathKnightTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(FrostDeathKnightTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(FrostDeathKnightTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(FrostDeathKnightTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(FrostDeathKnightTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Frost DeathKnight:\n";
    metrics.Print();
}
