 ...
 *
 * Blood DeathKnight Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Runes + Runic Power
 *
 * Tests all aspects of Blood DeathKnight AI behavior including:
...
class BloodDeathKnightTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DEATH_KNIGHT, 80, 1);
...
TEST_F(BloodDeathKnightTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(BloodDeathKnightTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(BloodDeathKnightTest, ResourceManagement_UsesRunes + Runic Power_Efficiently)
{
...
TEST_F(BloodDeathKnightTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(BloodDeathKnightTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(BloodDeathKnightTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(BloodDeathKnightTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(BloodDeathKnightTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(BloodDeathKnightTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(BloodDeathKnightTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(BloodDeathKnightTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(BloodDeathKnightTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(BloodDeathKnightTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(BloodDeathKnightTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(BloodDeathKnightTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Blood DeathKnight:\n";
    metrics.Print();
}
