 ...
 *
 * Fury Warrior Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Rage
 *
 * Tests all aspects of Fury Warrior AI behavior including:
...
class FuryWarriorTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_WARRIOR, 80, 2);
...
TEST_F(FuryWarriorTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(FuryWarriorTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(FuryWarriorTest, ResourceManagement_UsesRage_Efficiently)
{
...
TEST_F(FuryWarriorTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(FuryWarriorTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(FuryWarriorTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(FuryWarriorTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(FuryWarriorTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(FuryWarriorTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(FuryWarriorTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(FuryWarriorTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(FuryWarriorTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(FuryWarriorTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(FuryWarriorTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(FuryWarriorTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Fury Warrior:\n";
    metrics.Print();
}
