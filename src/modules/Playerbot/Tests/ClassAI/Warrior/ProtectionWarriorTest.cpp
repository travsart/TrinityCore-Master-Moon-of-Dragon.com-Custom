 ...
 *
 * Protection Warrior Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Rage
 *
 * Tests all aspects of Protection Warrior AI behavior including:
...
class ProtectionWarriorTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(ProtectionWarriorTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ProtectionWarriorTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ProtectionWarriorTest, ResourceManagement_UsesRage_Efficiently)
{
...
TEST_F(ProtectionWarriorTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ProtectionWarriorTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ProtectionWarriorTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(ProtectionWarriorTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ProtectionWarriorTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(ProtectionWarriorTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ProtectionWarriorTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ProtectionWarriorTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ProtectionWarriorTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ProtectionWarriorTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ProtectionWarriorTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ProtectionWarriorTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Protection Warrior:\n";
    metrics.Print();
}
