 ...
 *
 * Arms Warrior Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Rage
 *
 * Tests all aspects of Arms Warrior AI behavior including:
...
class ArmsWarriorTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_WARRIOR, 80, 1);
...
TEST_F(ArmsWarriorTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ArmsWarriorTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ArmsWarriorTest, ResourceManagement_UsesRage_Efficiently)
{
...
TEST_F(ArmsWarriorTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ArmsWarriorTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ArmsWarriorTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(ArmsWarriorTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ArmsWarriorTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(ArmsWarriorTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ArmsWarriorTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ArmsWarriorTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ArmsWarriorTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ArmsWarriorTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ArmsWarriorTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ArmsWarriorTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Arms Warrior:\n";
    metrics.Print();
}
