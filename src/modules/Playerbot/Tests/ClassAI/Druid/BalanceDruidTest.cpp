 ...
 *
 * Balance Druid Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Astral Power
 *
 * Tests all aspects of Balance Druid AI behavior including:
...
class BalanceDruidTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DRUID, 80, 1);
...
TEST_F(BalanceDruidTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(BalanceDruidTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(BalanceDruidTest, ResourceManagement_UsesAstral Power_Efficiently)
{
...
TEST_F(BalanceDruidTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(BalanceDruidTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(BalanceDruidTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(BalanceDruidTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(BalanceDruidTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(BalanceDruidTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(BalanceDruidTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(BalanceDruidTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(BalanceDruidTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(BalanceDruidTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(BalanceDruidTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(BalanceDruidTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Balance Druid:\n";
    metrics.Print();
}
