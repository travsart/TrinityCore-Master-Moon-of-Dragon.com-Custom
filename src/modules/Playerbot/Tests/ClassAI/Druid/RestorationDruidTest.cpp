 ...
 *
 * Restoration Druid Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Mana
 *
 * Tests all aspects of Restoration Druid AI behavior including:
...
class RestorationDruidTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DRUID, 80, 4);
...
TEST_F(RestorationDruidTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(RestorationDruidTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(RestorationDruidTest, ResourceManagement_UsesMana_Efficiently)
{
...
TEST_F(RestorationDruidTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(RestorationDruidTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(RestorationDruidTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(RestorationDruidTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(RestorationDruidTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(RestorationDruidTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(RestorationDruidTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(RestorationDruidTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(RestorationDruidTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(RestorationDruidTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(RestorationDruidTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(RestorationDruidTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Restoration Druid:\n";
    metrics.Print();
}
