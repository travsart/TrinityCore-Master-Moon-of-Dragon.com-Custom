 ...
 *
 * Feral Druid Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Energy + Combo Points
 *
 * Tests all aspects of Feral Druid AI behavior including:
...
class FeralDruidTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DRUID, 80, 2);
...
TEST_F(FeralDruidTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(FeralDruidTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(FeralDruidTest, ResourceManagement_UsesEnergy + Combo Points_Efficiently)
{
...
TEST_F(FeralDruidTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(FeralDruidTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(FeralDruidTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(FeralDruidTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(FeralDruidTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(FeralDruidTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(FeralDruidTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(FeralDruidTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(FeralDruidTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(FeralDruidTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(FeralDruidTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(FeralDruidTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Feral Druid:\n";
    metrics.Print();
}
