 ...
 *
 * Guardian Druid Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Rage
 *
 * Tests all aspects of Guardian Druid AI behavior including:
...
class GuardianDruidTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DRUID, 80, 3);
...
TEST_F(GuardianDruidTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(GuardianDruidTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(GuardianDruidTest, ResourceManagement_UsesRage_Efficiently)
{
...
TEST_F(GuardianDruidTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(GuardianDruidTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(GuardianDruidTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(GuardianDruidTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(GuardianDruidTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(GuardianDruidTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(GuardianDruidTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(GuardianDruidTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(GuardianDruidTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(GuardianDruidTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(GuardianDruidTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(GuardianDruidTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Guardian Druid:\n";
    metrics.Print();
}
