 ...
 *
 * Brewmaster Monk Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Energy
 *
 * Tests all aspects of Brewmaster Monk AI behavior including:
...
class BrewmasterMonkTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_MONK, 80, 1);
...
TEST_F(BrewmasterMonkTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(BrewmasterMonkTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(BrewmasterMonkTest, ResourceManagement_UsesEnergy_Efficiently)
{
...
TEST_F(BrewmasterMonkTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(BrewmasterMonkTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(BrewmasterMonkTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(BrewmasterMonkTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(BrewmasterMonkTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(BrewmasterMonkTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(BrewmasterMonkTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(BrewmasterMonkTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(BrewmasterMonkTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(BrewmasterMonkTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(BrewmasterMonkTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(BrewmasterMonkTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Brewmaster Monk:\n";
    metrics.Print();
}
