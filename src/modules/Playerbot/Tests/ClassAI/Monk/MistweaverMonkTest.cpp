 ...
 *
 * Mistweaver Monk Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Mana + Chi
 *
 * Tests all aspects of Mistweaver Monk AI behavior including:
...
class MistweaverMonkTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_MONK, 80, 2);
...
TEST_F(MistweaverMonkTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(MistweaverMonkTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(MistweaverMonkTest, ResourceManagement_UsesMana + Chi_Efficiently)
{
...
TEST_F(MistweaverMonkTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(MistweaverMonkTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(MistweaverMonkTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(MistweaverMonkTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(MistweaverMonkTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(MistweaverMonkTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(MistweaverMonkTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(MistweaverMonkTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(MistweaverMonkTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(MistweaverMonkTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(MistweaverMonkTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(MistweaverMonkTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Mistweaver Monk:\n";
    metrics.Print();
}
