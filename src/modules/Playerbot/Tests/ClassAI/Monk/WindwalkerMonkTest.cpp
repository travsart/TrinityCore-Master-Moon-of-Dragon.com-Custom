 ...
 *
 * Windwalker Monk Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Energy + Chi
 *
 * Tests all aspects of Windwalker Monk AI behavior including:
...
class WindwalkerMonkTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_MONK, 80, 3);
...
TEST_F(WindwalkerMonkTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(WindwalkerMonkTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(WindwalkerMonkTest, ResourceManagement_UsesEnergy + Chi_Efficiently)
{
...
TEST_F(WindwalkerMonkTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(WindwalkerMonkTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(WindwalkerMonkTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(WindwalkerMonkTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(WindwalkerMonkTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(WindwalkerMonkTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(WindwalkerMonkTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(WindwalkerMonkTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(WindwalkerMonkTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(WindwalkerMonkTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(WindwalkerMonkTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(WindwalkerMonkTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Windwalker Monk:\n";
    metrics.Print();
}
