 ...
 *
 * Enhancement Shaman Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Mana + Maelstrom
 *
 * Tests all aspects of Enhancement Shaman AI behavior including:
...
class EnhancementShamanTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_SHAMAN, 80, 2);
...
TEST_F(EnhancementShamanTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(EnhancementShamanTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(EnhancementShamanTest, ResourceManagement_UsesMana + Maelstrom_Efficiently)
{
...
TEST_F(EnhancementShamanTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(EnhancementShamanTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(EnhancementShamanTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(EnhancementShamanTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(EnhancementShamanTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(EnhancementShamanTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(EnhancementShamanTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(EnhancementShamanTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(EnhancementShamanTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(EnhancementShamanTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(EnhancementShamanTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(EnhancementShamanTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Enhancement Shaman:\n";
    metrics.Print();
}
