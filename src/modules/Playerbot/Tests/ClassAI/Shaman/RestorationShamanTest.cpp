 ...
 *
 * Restoration Shaman Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Mana
 *
 * Tests all aspects of Restoration Shaman AI behavior including:
...
class RestorationShamanTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_SHAMAN, 80, 3);
...
TEST_F(RestorationShamanTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(RestorationShamanTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(RestorationShamanTest, ResourceManagement_UsesMana_Efficiently)
{
...
TEST_F(RestorationShamanTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(RestorationShamanTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(RestorationShamanTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(RestorationShamanTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(RestorationShamanTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(RestorationShamanTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(RestorationShamanTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(RestorationShamanTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(RestorationShamanTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(RestorationShamanTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(RestorationShamanTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(RestorationShamanTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Restoration Shaman:\n";
    metrics.Print();
}
