 ...
 *
 * Elemental Shaman Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Maelstrom
 *
 * Tests all aspects of Elemental Shaman AI behavior including:
...
class ElementalShamanTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_SHAMAN, 80, 1);
...
TEST_F(ElementalShamanTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ElementalShamanTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ElementalShamanTest, ResourceManagement_UsesMana + Maelstrom_Efficiently)
{
...
TEST_F(ElementalShamanTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ElementalShamanTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ElementalShamanTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(ElementalShamanTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ElementalShamanTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(ElementalShamanTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ElementalShamanTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ElementalShamanTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ElementalShamanTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ElementalShamanTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ElementalShamanTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ElementalShamanTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Elemental Shaman:\n";
    metrics.Print();
}
