 ...
 *
 * Vengeance DemonHunter Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Fury + Pain
 *
 * Tests all aspects of Vengeance DemonHunter AI behavior including:
...
class VengeanceDemonHunterTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DEMON_HUNTER, 80, 2);
...
TEST_F(VengeanceDemonHunterTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(VengeanceDemonHunterTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(VengeanceDemonHunterTest, ResourceManagement_UsesFury + Pain_Efficiently)
{
...
TEST_F(VengeanceDemonHunterTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(VengeanceDemonHunterTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
// ============================================================================
// TEST 6: DEFENSIVE COOLDOWNS - Tank SPECIFIC
// ============================================================================

TEST_F(VengeanceDemonHunterTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(VengeanceDemonHunterTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(VengeanceDemonHunterTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(VengeanceDemonHunterTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(VengeanceDemonHunterTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(VengeanceDemonHunterTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(VengeanceDemonHunterTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(VengeanceDemonHunterTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(VengeanceDemonHunterTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(VengeanceDemonHunterTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Vengeance DemonHunter:\n";
    metrics.Print();
}
