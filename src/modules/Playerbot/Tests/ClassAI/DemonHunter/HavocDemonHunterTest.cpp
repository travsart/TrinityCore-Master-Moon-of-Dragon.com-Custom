 ...
 *
 * Havoc DemonHunter Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Fury
 *
 * Tests all aspects of Havoc DemonHunter AI behavior including:
...
class HavocDemonHunterTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_DEMON_HUNTER, 80, 1);
...
TEST_F(HavocDemonHunterTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(HavocDemonHunterTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(HavocDemonHunterTest, ResourceManagement_UsesFury_Efficiently)
{
...
TEST_F(HavocDemonHunterTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(HavocDemonHunterTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(HavocDemonHunterTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(HavocDemonHunterTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(HavocDemonHunterTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(HavocDemonHunterTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(HavocDemonHunterTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(HavocDemonHunterTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(HavocDemonHunterTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(HavocDemonHunterTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(HavocDemonHunterTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(HavocDemonHunterTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Havoc DemonHunter:\n";
    metrics.Print();
}
