 ...
 *
 * Demonology Warlock Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Soul Shards + Pet
 *
 * Tests all aspects of Demonology Warlock AI behavior including:
...
class DemonologyWarlockTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_WARLOCK, 80, 2);
...
TEST_F(DemonologyWarlockTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(DemonologyWarlockTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(DemonologyWarlockTest, ResourceManagement_UsesMana + Soul Shards + Pet_Efficiently)
{
...
TEST_F(DemonologyWarlockTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(DemonologyWarlockTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
// ============================================================================
// TEST 6: DEFENSIVE COOLDOWNS - Ranged DPS SPECIFIC
// ============================================================================

TEST_F(DemonologyWarlockTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(DemonologyWarlockTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(DemonologyWarlockTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(DemonologyWarlockTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(DemonologyWarlockTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(DemonologyWarlockTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(DemonologyWarlockTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(DemonologyWarlockTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(DemonologyWarlockTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(DemonologyWarlockTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Demonology Warlock:\n";
    metrics.Print();
}
