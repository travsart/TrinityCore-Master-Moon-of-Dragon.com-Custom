 ...
 *
 * Affliction Warlock Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Soul Shards
 *
 * Tests all aspects of Affliction Warlock AI behavior including:
...
class AfflictionWarlockTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_WARLOCK, 80, 1);
...
TEST_F(AfflictionWarlockTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(AfflictionWarlockTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(AfflictionWarlockTest, ResourceManagement_UsesMana + Soul Shards_Efficiently)
{
...
TEST_F(AfflictionWarlockTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(AfflictionWarlockTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(AfflictionWarlockTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(AfflictionWarlockTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(AfflictionWarlockTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(AfflictionWarlockTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(AfflictionWarlockTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(AfflictionWarlockTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(AfflictionWarlockTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(AfflictionWarlockTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(AfflictionWarlockTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(AfflictionWarlockTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Affliction Warlock:\n";
    metrics.Print();
}
