 ...
 *
 * Destruction Warlock Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Soul Shards
 *
 * Tests all aspects of Destruction Warlock AI behavior including:
...
class DestructionWarlockTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_WARLOCK, 80, 3);
...
TEST_F(DestructionWarlockTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(DestructionWarlockTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(DestructionWarlockTest, ResourceManagement_UsesMana + Soul Shards_Efficiently)
{
...
TEST_F(DestructionWarlockTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(DestructionWarlockTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(DestructionWarlockTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(DestructionWarlockTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(DestructionWarlockTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(DestructionWarlockTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(DestructionWarlockTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(DestructionWarlockTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(DestructionWarlockTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(DestructionWarlockTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(DestructionWarlockTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(DestructionWarlockTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Destruction Warlock:\n";
    metrics.Print();
}
