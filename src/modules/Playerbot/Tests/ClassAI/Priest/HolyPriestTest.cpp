 ...
 *
 * Holy Priest Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Mana
 *
 * Tests all aspects of Holy Priest AI behavior including:
...
class HolyPriestTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_PRIEST, 80, 2);
...
TEST_F(HolyPriestTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(HolyPriestTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(HolyPriestTest, ResourceManagement_UsesMana_Efficiently)
{
...
TEST_F(HolyPriestTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(HolyPriestTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(HolyPriestTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(HolyPriestTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(HolyPriestTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(HolyPriestTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(HolyPriestTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(HolyPriestTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(HolyPriestTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(HolyPriestTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(HolyPriestTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(HolyPriestTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Holy Priest:\n";
    metrics.Print();
}
