 ...
 *
 * Discipline Priest Specialization - Comprehensive Unit Tests
 *
 * Role: Healer
 * Resource: Mana
 *
 * Tests all aspects of Discipline Priest AI behavior including:
...
class DisciplinePriestTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_PRIEST, 80, 1);
...
TEST_F(DisciplinePriestTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(DisciplinePriestTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(DisciplinePriestTest, ResourceManagement_UsesMana_Efficiently)
{
...
TEST_F(DisciplinePriestTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(DisciplinePriestTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(DisciplinePriestTest, DefensiveCooldowns_UsesDefensives_HEALER)
{
...
TEST_F(DisciplinePriestTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(DisciplinePriestTest, TargetSelection_PrioritizesHealerTargets)
{
...
TEST_F(DisciplinePriestTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(DisciplinePriestTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(DisciplinePriestTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(DisciplinePriestTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(DisciplinePriestTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(DisciplinePriestTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(DisciplinePriestTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Discipline Priest:\n";
    metrics.Print();
}
