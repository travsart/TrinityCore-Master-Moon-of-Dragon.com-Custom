 ...
 *
 * Shadow Priest Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Insanity
 *
 * Tests all aspects of Shadow Priest AI behavior including:
...
class ShadowPriestTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_PRIEST, 80, 3);
...
TEST_F(ShadowPriestTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ShadowPriestTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ShadowPriestTest, ResourceManagement_UsesMana + Insanity_Efficiently)
{
...
TEST_F(ShadowPriestTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ShadowPriestTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ShadowPriestTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(ShadowPriestTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ShadowPriestTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(ShadowPriestTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ShadowPriestTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ShadowPriestTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ShadowPriestTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ShadowPriestTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ShadowPriestTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ShadowPriestTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Shadow Priest:\n";
    metrics.Print();
}
