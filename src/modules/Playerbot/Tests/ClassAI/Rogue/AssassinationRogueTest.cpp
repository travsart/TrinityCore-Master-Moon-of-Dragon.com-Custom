 ...
 *
 * Assassination Rogue Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Energy + Combo Points
 *
 * Tests all aspects of Assassination Rogue AI behavior including:
...
class AssassinationRogueTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_ROGUE, 80, 1);
...
TEST_F(AssassinationRogueTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(AssassinationRogueTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(AssassinationRogueTest, ResourceManagement_UsesEnergy + Combo Points_Efficiently)
{
...
TEST_F(AssassinationRogueTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(AssassinationRogueTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(AssassinationRogueTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(AssassinationRogueTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(AssassinationRogueTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(AssassinationRogueTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(AssassinationRogueTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(AssassinationRogueTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(AssassinationRogueTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(AssassinationRogueTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(AssassinationRogueTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(AssassinationRogueTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Assassination Rogue:\n";
    metrics.Print();
}
