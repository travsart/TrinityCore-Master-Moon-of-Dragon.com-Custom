 ...
 *
 * Subtlety Rogue Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Energy + Combo Points
 *
 * Tests all aspects of Subtlety Rogue AI behavior including:
...
class SubtletyRogueTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_ROGUE, 80, 3);
...
TEST_F(SubtletyRogueTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(SubtletyRogueTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(SubtletyRogueTest, ResourceManagement_UsesEnergy + Combo Points_Efficiently)
{
...
TEST_F(SubtletyRogueTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(SubtletyRogueTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(SubtletyRogueTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(SubtletyRogueTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(SubtletyRogueTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(SubtletyRogueTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(SubtletyRogueTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(SubtletyRogueTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(SubtletyRogueTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(SubtletyRogueTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(SubtletyRogueTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(SubtletyRogueTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Subtlety Rogue:\n";
    metrics.Print();
}
