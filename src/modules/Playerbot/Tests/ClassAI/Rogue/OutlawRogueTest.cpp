 ...
 *
 * Outlaw Rogue Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Energy + Combo Points
 *
 * Tests all aspects of Outlaw Rogue AI behavior including:
...
class OutlawRogueTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_ROGUE, 80, 2);
...
TEST_F(OutlawRogueTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(OutlawRogueTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(OutlawRogueTest, ResourceManagement_UsesEnergy + Combo Points_Efficiently)
{
...
TEST_F(OutlawRogueTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(OutlawRogueTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(OutlawRogueTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(OutlawRogueTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(OutlawRogueTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(OutlawRogueTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(OutlawRogueTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(OutlawRogueTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(OutlawRogueTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(OutlawRogueTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(OutlawRogueTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(OutlawRogueTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Outlaw Rogue:\n";
    metrics.Print();
}
