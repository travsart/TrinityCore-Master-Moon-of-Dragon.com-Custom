 ...
 *
 * Retribution Paladin Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Mana + Holy Power
 *
 * Tests all aspects of Retribution Paladin AI behavior including:
...
class RetributionPaladinTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_PALADIN, 80, 3);
...
TEST_F(RetributionPaladinTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(RetributionPaladinTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(RetributionPaladinTest, ResourceManagement_UsesMana + Holy Power_Efficiently)
{
...
TEST_F(RetributionPaladinTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(RetributionPaladinTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(RetributionPaladinTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(RetributionPaladinTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(RetributionPaladinTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(RetributionPaladinTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(RetributionPaladinTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(RetributionPaladinTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(RetributionPaladinTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(RetributionPaladinTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(RetributionPaladinTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(RetributionPaladinTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Retribution Paladin:\n";
    metrics.Print();
}
