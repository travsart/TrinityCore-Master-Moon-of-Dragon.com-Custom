 ...
 *
 * Protection Paladin Specialization - Comprehensive Unit Tests
 *
 * Role: Tank
 * Resource: Mana + Holy Power
 *
 * Tests all aspects of Protection Paladin AI behavior including:
...
class ProtectionPaladinTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_PALADIN, 80, 2);
...
TEST_F(ProtectionPaladinTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ProtectionPaladinTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ProtectionPaladinTest, ResourceManagement_UsesMana + Holy Power_Efficiently)
{
...
TEST_F(ProtectionPaladinTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ProtectionPaladinTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ProtectionPaladinTest, DefensiveCooldowns_UsesDefensives_TANK)
{
...
TEST_F(ProtectionPaladinTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ProtectionPaladinTest, TargetSelection_PrioritizesTankTargets)
{
...
TEST_F(ProtectionPaladinTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ProtectionPaladinTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ProtectionPaladinTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ProtectionPaladinTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ProtectionPaladinTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ProtectionPaladinTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ProtectionPaladinTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Protection Paladin:\n";
    metrics.Print();
}
