 ...
 *
 * BeastMastery Hunter Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Focus + Pet
 *
 * Tests all aspects of BeastMastery Hunter AI behavior including:
...
class BeastMasteryHunterTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_HUNTER, 80, 1);
...
TEST_F(BeastMasteryHunterTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(BeastMasteryHunterTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(BeastMasteryHunterTest, ResourceManagement_UsesFocus + Pet_Efficiently)
{
...
TEST_F(BeastMasteryHunterTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(BeastMasteryHunterTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(BeastMasteryHunterTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(BeastMasteryHunterTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(BeastMasteryHunterTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(BeastMasteryHunterTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(BeastMasteryHunterTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(BeastMasteryHunterTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(BeastMasteryHunterTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(BeastMasteryHunterTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(BeastMasteryHunterTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(BeastMasteryHunterTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for BeastMastery Hunter:\n";
    metrics.Print();
}
