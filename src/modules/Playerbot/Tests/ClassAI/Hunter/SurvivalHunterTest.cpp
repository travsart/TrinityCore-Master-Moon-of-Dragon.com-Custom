 ...
 *
 * Survival Hunter Specialization - Comprehensive Unit Tests
 *
 * Role: Melee DPS
 * Resource: Focus
 *
 * Tests all aspects of Survival Hunter AI behavior including:
...
class SurvivalHunterTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_HUNTER, 80, 3);
...
TEST_F(SurvivalHunterTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(SurvivalHunterTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(SurvivalHunterTest, ResourceManagement_UsesFocus_Efficiently)
{
...
TEST_F(SurvivalHunterTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(SurvivalHunterTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(SurvivalHunterTest, DefensiveCooldowns_UsesDefensives_MELEE DPS)
{
...
TEST_F(SurvivalHunterTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(SurvivalHunterTest, TargetSelection_PrioritizesMelee DPSTargets)
{
...
TEST_F(SurvivalHunterTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(SurvivalHunterTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(SurvivalHunterTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(SurvivalHunterTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(SurvivalHunterTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(SurvivalHunterTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(SurvivalHunterTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Survival Hunter:\n";
    metrics.Print();
}
