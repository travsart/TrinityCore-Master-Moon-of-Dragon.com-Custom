 ...
 *
 * Marksmanship Hunter Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Focus
 *
 * Tests all aspects of Marksmanship Hunter AI behavior including:
...
class MarksmanshipHunterTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_HUNTER, 80, 2);
...
TEST_F(MarksmanshipHunterTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(MarksmanshipHunterTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(MarksmanshipHunterTest, ResourceManagement_UsesFocus_Efficiently)
{
...
TEST_F(MarksmanshipHunterTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(MarksmanshipHunterTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(MarksmanshipHunterTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(MarksmanshipHunterTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(MarksmanshipHunterTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(MarksmanshipHunterTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(MarksmanshipHunterTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(MarksmanshipHunterTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(MarksmanshipHunterTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(MarksmanshipHunterTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(MarksmanshipHunterTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(MarksmanshipHunterTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Marksmanship Hunter:\n";
    metrics.Print();
}
