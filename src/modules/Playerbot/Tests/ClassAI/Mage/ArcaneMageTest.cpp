 ...
 *
 * Arcane Mage Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana + Arcane Charges
 *
 * Tests all aspects of Arcane Mage AI behavior including:
...
class ArcaneMageTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_MAGE, 80, 1);
...
TEST_F(ArcaneMageTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(ArcaneMageTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(ArcaneMageTest, ResourceManagement_UsesMana + Arcane Charges_Efficiently)
{
...
TEST_F(ArcaneMageTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(ArcaneMageTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(ArcaneMageTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(ArcaneMageTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(ArcaneMageTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(ArcaneMageTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(ArcaneMageTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(ArcaneMageTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(ArcaneMageTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(ArcaneMageTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(ArcaneMageTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(ArcaneMageTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Arcane Mage:\n";
    metrics.Print();
}
