 ...
 *
 * Frost Mage Specialization - Comprehensive Unit Tests
 *
 * Role: Ranged DPS
 * Resource: Mana
 *
 * Tests all aspects of Frost Mage AI behavior including:
...
class FrostMageTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
        bot = CreateTestBot(CLASS_MAGE, 80, 3);
...
TEST_F(FrostMageTest, RotationPriority_UsesPrimaryAbility_InOptimalConditions)
{
...
TEST_F(FrostMageTest, RotationPriority_UsesSecondaryAbility_WhenPrimaryOnCooldown)
{
...
TEST_F(FrostMageTest, ResourceManagement_UsesMana_Efficiently)
{
...
TEST_F(FrostMageTest, ResourceManagement_AvoidsResourceCapping)
{
...
TEST_F(FrostMageTest, CooldownUsage_UsesMajorCooldown_AtOptimalTime)
{
...
TEST_F(FrostMageTest, DefensiveCooldowns_UsesDefensives_RANGED DPS)
{
...
TEST_F(FrostMageTest, InterruptLogic_InterruptsEnemyCasts)
{
...
TEST_F(FrostMageTest, TargetSelection_PrioritizesRanged DPSTargets)
{
...
TEST_F(FrostMageTest, AoEDecisions_UsesAoEAbilities_With3PlusEnemies)
{
...
TEST_F(FrostMageTest, AoEDecisions_UsesSingleTarget_With1Or2Enemies)
{
    // Arrange: 1-2 enemies
...
TEST_F(FrostMageTest, BuffManagement_MaintainsKeyBuffs)
{
...
TEST_F(FrostMageTest, DebuffManagement_AppliesKeyDebuffs)
{
...
TEST_F(FrostMageTest, EdgeCase_SurvivesWithLowResourcesAndHealth)
{
...
TEST_F(FrostMageTest, GroupSynergy_CoordinatesWithGroupMembers)
{
...
TEST_F(FrostMageTest, Performance_DecisionCycle_CompletesUnder1ms)
{
    ...
    std::cout << "Performance for Frost Mage:\n";
    metrics.Print();
}
