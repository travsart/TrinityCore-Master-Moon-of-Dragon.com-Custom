...
// See central registry: WoW112Spells::Shaman and WoW112Spells::Shaman::Restoration
constexpr uint32 REST_HEALING_WAVE = 77472;              // -> WoW112Spells::Shaman::Restoration::HEALING_WAVE
constexpr uint32 REST_HEALING_SURGE = 8004;              // -> WoW112Spells::Shaman::Restoration::HEALING_SURGE
constexpr uint32 REST_CHAIN_HEAL = 1064;                 // -> WoW112Spells::Shaman::Restoration::CHAIN_HEAL
constexpr uint32 REST_RIPTIDE = 61295;                   // -> WoW112Spells::Shaman::Restoration::RIPTIDE
constexpr uint32 REST_HEALING_RAIN = 73920;              // -> WoW112Spells::Shaman::Restoration::HEALING_RAIN
constexpr uint32 REST_WELLSPRING = 197995;               // -> WoW112Spells::Shaman::Restoration::WELLSPRING
constexpr uint32 REST_HEALING_TIDE_TOTEM = 108280;       // -> WoW112Spells::Shaman::Restoration::HEALING_TIDE_TOTEM
constexpr uint32 REST_CLOUDBURST_TOTEM = 157153;         // -> WoW112Spells::Shaman::Restoration::CLOUDBURST_TOTEM
constexpr uint32 REST_SPIRIT_LINK_TOTEM = 98008;         // -> WoW112Spells::Shaman::Restoration::SPIRIT_LINK_TOTEM
constexpr uint32 REST_EARTHEN_WALL_TOTEM = 198838;       // -> WoW112Spells::Shaman::Restoration::EARTHEN_WALL_TOTEM
constexpr uint32 REST_ANCESTRAL_PROTECTION_TOTEM = 207399; // -> WoW112Spells::Shaman::Restoration::ANCESTRAL_PROTECTION_TOTEM
constexpr uint32 REST_ASCENDANCE = 114052;               // -> WoW112Spells::Shaman::Restoration::ASCENDANCE_RESTO
constexpr uint32 REST_UNLEASH_LIFE = 73685;              // -> WoW112Spells::Shaman::Restoration::UNLEASH_LIFE
constexpr uint32 REST_EARTH_SHIELD = 974;                // -> WoW112Spells::Shaman::Restoration::EARTH_SHIELD
constexpr uint32 REST_WATER_SHIELD = 52127;              // -> WoW112Spells::Shaman::Restoration::WATER_SHIELD
constexpr uint32 REST_PURIFY_SPIRIT = 77130;             // -> WoW112Spells::Shaman::Restoration::PURIFY_SPIRIT
constexpr uint32 REST_SPIRITWALKERS_GRACE = 79206;       // -> WoW112Spells::Shaman::Restoration::SPIRITWALKERS_GRACE
constexpr uint32 REST_ASTRAL_SHIFT = 108271;             // -> WoW112Spells::Shaman::ASTRAL_SHIFT
constexpr uint32 REST_WIND_SHEAR = 57994;                // -> WoW112Spells::Shaman::WIND_SHEAR
