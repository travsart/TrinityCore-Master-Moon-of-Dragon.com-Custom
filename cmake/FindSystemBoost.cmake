# FindSystemBoost.cmake - Force use of system Boost 1.89 instead of vcpkg
...
# Explicitly set Boost paths to 1.89 installation
...
message(STATUS "Forcing system Boost 1.89 from: ${BOOST_ROOT}")
...
if(Boost_INCLUDE_DIRS AND Boost_THREAD_LIBRARY_RELEASE AND Boost_FILESYSTEM_LIBRARY_RELEASE AND Boost_PROGRAM_OPTIONS_LIBRARY_RELEASE AND Boost_REGEX_LIBRARY_RELEASE AND Boost_LOCALE_LIBRARY_RELEASE)
    ...
    message(STATUS "✅ System Boost 1.89 found at: ${Boost_INCLUDE_DIRS}")
    message(STATUS "✅ Boost Release libraries: ${Boost_THREAD_LIBRARY_RELEASE};${Boost_FILESYSTEM_LIBRARY_RELEASE};${Boost_PROGRAM_OPTIONS_LIBRARY_RELEASE};${Boost_REGEX_LIBRARY_RELEASE};${Boost_LOCALE_LIBRARY_RELEASE}")
    message(STATUS "✅ Boost Debug libraries: ${Boost_THREAD_LIBRARY_DEBUG};${Boost_FILESYSTEM_LIBRARY_DEBUG};${Boost_PROGRAM_OPTIONS_LIBRARY_DEBUG};${Boost_REGEX_LIBRARY_DEBUG};${Boost_LOCALE_LIBRARY_DEBUG}")
else()
    ...
    message(FATAL_ERROR "❌ System Boost 1.89 not found at specified path")
endif()
